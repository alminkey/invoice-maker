...
export function InvoicePdf({ profile, client, invoice, labels }: {
  ...
  const total = calcInvoiceTotal(invoice).toFixed(2);
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <View style={{ borderTop: '1 solid #cbd5e1', marginTop: 6, paddingTop: 6, flexDirection: 'row', justifyContent: 'flex-end' }}>
            <Text style={{ fontWeight: 700 }}>{labels['total']}: {total} {invoice.currency}</Text>
          </View>
        </View>
